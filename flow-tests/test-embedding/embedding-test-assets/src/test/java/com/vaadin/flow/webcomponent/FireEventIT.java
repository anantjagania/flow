...
public class FireEventIT extends EmbeddingChromeBrowserTest implements HasById {
    ...
    public void customEventsGetSentToTheClientSide() {
        ...
        Assertions.assertEquals("Sum should be 0", "0", value(SUM));
        Assertions.assertEquals("Error should be empty", "", value(ERR));
        ...
        Assertions.assertEquals("Sum should be 8", "8", value(SUM));
        Assertions.assertEquals("Error should be empty", "", value(ERR));

        number1.clear();
        number2.clear();

        Assertions.assertEquals("", value(number1));
        Assertions.assertEquals("", value(number2));

        button.click();

        Assertions.assertEquals("Sum should not have changed", "8", value(SUM));
        Assertions.assertEquals("Error should have been raised", "empty String",
                value(ERR));
        ...
        Assertions.assertEquals("Sum should be 200", "200", value(SUM));
    }
    ...
    public void options_bubblesAndCancelableAreRecordedOntoTheEventAndWork() {
        ...
        Assertions.assertEquals("Non-bubbling event should be visible on the " +
                "web component", NoBubble_NoCancel.name(), value(CON_RESULT));
        Assertions.assertEquals("Non-bubbling event should not be visible on the " +
        ...
        Assertions.assertEquals("Bubbling, non-cancellable event should be " +
                "visible on the web component", Bubble_NoCancel.name(),
                value(CON_RESULT));
        Assertions.assertEquals("Bubbling, non-cancelable event should be visible on the " +
        ...
        Assertions.assertEquals("Bubbling, cancellable event should be " +
                "visible on the web component", Bubble_Cancel.name(),
                value(CON_RESULT));
        Assertions.assertEquals("Bubbling, cancelable event should be visible on the " +
         ...
         */
        Assertions.assertEquals("Bubbling, cancelable event should not be visible on the " +

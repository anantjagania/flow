...
public class PolymerPropertyMutationInObserverIT extends ChromeBrowserTest {
    ...
    public void property_mutation_inside_observers_synced_correctly() {
        ...
        Assertions.assertEquals("Value changed twice initially", 2,
                modelValueDivs.size());
        ...
        Assertions.assertEquals("Value changed 4 times in total after backspace", 4,
                modelValueDivs.size());
        Assertions.assertEquals("User action mutation synced to server",

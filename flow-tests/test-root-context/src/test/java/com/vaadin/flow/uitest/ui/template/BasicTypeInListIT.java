...
public class BasicTypeInListIT extends ChromeBrowserTest {
    ...
    public void basicTypeInModeList() {
        ...
        Assertions.assertEquals("foo", items.get(0).getText());
        Assertions.assertEquals("bar", items.get(1).getText());
        ...
        Assertions.assertEquals("newItem", items.get(2).getText());
        ...
        Assertions.assertEquals(2, items.size());
        Assertions.assertEquals("bar", items.get(0).getText());
    }
}
